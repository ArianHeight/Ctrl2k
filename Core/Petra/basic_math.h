...
template <typename T> requires TYPE_NUMBER<T> constexpr T EPSILON;
...
template <typename T> requires TYPE_NUMBER<T> constexpr T PI;
...
template <typename T> requires TYPE_NUMBER<T> constexpr T DEGREE_TO_RAD;
...
template <typename T> requires TYPE_NUMBER<T> constexpr T RAD_TO_DEGREE;
