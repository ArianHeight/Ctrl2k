...
interface class/structs|interface_snake_case
abstract class/structs|abstract_snake_case
template type parameters|single capital letter, usually T, U, V, etc.
template paramters|_snake_case
enum values|SCREAMING_SNAKE_CASE
files|snake_case(apart from files that match the project name)
...
interface class/structs|IPascalCase
abstract class/structs|APascalCase
template type parameters|single capital letter, usually T, U, V, etc.
template paramters|_underscore_snake_case
enum values|SCREAMING_SNAKE_CASE
files|PascalCase
